...
def finish_episode(optimizer, policy, config, eps):
...
if __name__ == "__main__":
    ...
    for i_episode in range(config.num_episodes):
        ...
        observation_video = utils.VideoRecord(f"runs/{model_name}/{current_time}/observation/",
                                              f"observation-{i_episode}")
        ...
        for t in range(config.max_steps):
            ...
            if done:
                ...
                finish_episode(optimizer, policy, config, eps)
